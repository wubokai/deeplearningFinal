...
class Reconstructor_lip(nn.Module):
    def __init__(self):
        super(Reconstructor_lip, self).__init__()
    ...
    def forward(self, lip_sequences, face_sequences):
...
# reconstruct = Reconstructor_lip()
# tens1 = torch.randn(25, 3, 82, 2)
# tens2 = torch.randn(25, 3, 3, 96, 96)
# output = reconstruct(tens1, tens2)
# print(output.shape)
