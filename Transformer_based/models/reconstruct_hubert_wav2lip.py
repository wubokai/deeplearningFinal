...
class Reconstructor_hubert_wav2lip(nn.Module):
    def __init__(self):
        super(Reconstructor_hubert_wav2lip, self).__init__()
    ...
    def forward(self, lip_sequences, face_sequences, audio_sequences):  # B, 5, 10, 1024
        ...
        audio_sequences = audio_sequences.transpose(2, 3)
